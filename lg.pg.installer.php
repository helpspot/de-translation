...
define('lg_inst_config','You must rename config-empty.php to config.php and customize config.php before continuing');
...
define('lg_inst_checknotdb','HelpSpot can not connect to the database. Please check your database settings in config.php.');
define('lg_inst_checkmysql4','MySQL 5.6 or greater required.');
define('lg_inst_checkmysql4update','Your MySQL database is less than version 5.6. HelpSpot 4.6.8 and higher require MySQL 5.6 or greater. Please upgrade your database and then continue the HelpSpot upgrade.');
...
define('lg_inst_unabletodb','Unable to connect to the database, please check config.php');
...
define('lg_inst_upgradecomp2','Please delete installer.php');
define('lg_inst_upgradedberrors','Upgrade Database Errors');
define('lg_inst_upgradedberrors2','These errors are often due to database user permissions. Please fix the permissions or other error source and re-run <a href="installer.php">installer.php</a>.');
...
define('lg_inst_portal_msg','Welcome to the support center where you\'ll find support documentation, customer forums and request submission forms.');
define('lg_inst_dbnotloaded','Your config.php indicates that you want to use %s as your database. However that extension is not enabled in your PHP configuration. You must modify your php.ini file to enable the extension.');
...
define('lg_inst_settings_smtphostex','URL to SMTP server. e.g. smtp.example.com;');
...
<td align="right">
<a href="##REQUESTCHECKURL##">View the request</a>
</td>
</tr>
</table>
...
define('lg_inst_et_retrievepass','
Hello,
...
Note, this link expires after 15 minutes.
');

define('lg_inst_et_retrievepass_html','
<html>
<body>

<table width="100%" cellpadding="6" cellspacing="0" bgcolor="#dfe5ff">
<tr>
<td style="font-weight:bold;">Reset Password</td>
</tr>
</table>
...
<p>Note, this link expires after 15 minutes.</p>
...
define('lg_inst_et_newportalpass_html','
<html>
<body>
