...
define('lg_admin_settings_send_from_mailbox', 'Send from Mailbox');
define('lg_admin_settings_send_from_custom', 'Send via Custom Configuration');
define('lg_admin_settings_fileattachments', 'File Attachments');
define('lg_admin_settings_virus_scan', 'Scan files for viruses');
define('lg_admin_settings_virus_scan_descr', 'Scan uploaded files and email attachments via opswat.com');
define('lg_admin_settings_virus_total_key', 'Virus Scanner API Key');
define('lg_admin_settings_virus_total_key_descr', 'Developer API key generated by opswat.com');
...
define('lg_admin_settings_ss_redactor', 'Redact Social Security numbers (xxx-xx-xxxx) from message bodies');
define('lg_admin_settings_ss_no_dash_redactor', 'Redact Social Security numbers with no dashes (xxxxxxxxx) from message bodies');
define('lg_admin_settings_ss_redactor_descr', 'New requests & updates to existing requests are checked to see if they contain Social Security numbers with dashes. Please note that custom fields are not checked as a part of this feature.');
