...
define('lg_ajax_newversion','A new version of HelpSpot (%s) has been released. Details available in the <a href="admin.php?pg=admin">admin area</a>');
...
define('lg_reminderpopup_submit','Create');
...
define('lg_search_resultforum','Forum Results');
