...
define('lg_filter_requests_note','Filters are custom views into your requests allowing easy management and custom workflows');
...
define('lg_filter_requests_details','Filter Details');
